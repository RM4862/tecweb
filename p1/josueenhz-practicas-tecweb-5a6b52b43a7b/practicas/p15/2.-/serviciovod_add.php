...
echo "<input type='submit' value='Abrir nuevo XML'onclick=" . $comilla . "location.href='http://localhost/tecnologiasweb/practicas/p15/2.-/serviciovod.xml'" . $comilla . ">";
